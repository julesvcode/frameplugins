...
const $$Launch = createComponent(async ($$result, $$props, $$slots) => {
...
</h1> <p class="text-lg">Browse through all the tools you need to ${topic} your newsletter.</p> <!-- from email platform, to branding and copywriting. --> </div> </section> <section> <div class="grid grid-col-1 sm:grid-cols-2 md:grid-cols-3 gap-6 pt-4"> ${filteredTools.map(
    (tool) => renderTemplate`${renderComponent($$result2, "ToolCard", $$ToolCard, { "tools": tool })}`
  )} </div></section> ` })}`;
}, "/Users/new/Documents/GitHub/newsletter-supply/src/pages/launch.astro", void 0);

const $$file = "/Users/new/Documents/GitHub/newsletter-supply/src/pages/launch.astro";
const $$url = "/launch";

export { $$Launch as default, $$file as file, $$url as url };
