...
const $$Monetise = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$Monetise;
  const allTools = await getCollection("tools");
  const topic = "monetise";
...
</h1> <p class="text-lg">Browse through all the tools you need to ${topic} your newsletter.</p> </div> </section> <section id="tools"> <div class="grid grid-col-1 sm:grid-cols-2 md:grid-cols-3 gap-6 pt-4"> ${filteredTools.map(
    (tool) => renderTemplate`${renderComponent($$result2, "ToolCard", $$ToolCard, { "tools": tool })}`
  )} </div></section> ` })}`;
}, "/Users/new/Documents/GitHub/newsletter-supply/src/pages/monetise.astro", void 0);

const $$file = "/Users/new/Documents/GitHub/newsletter-supply/src/pages/monetise.astro";
const $$url = "/monetise";

export { $$Monetise as default, $$file as file, $$url as url };
