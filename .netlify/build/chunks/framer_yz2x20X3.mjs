const id = "framer.md";
						...
						const data = {title:"Framer",feat:"true",updateDate:new Date(1714608000000),description:"A website builder that empowers users to design and publish stunning websites without the need to code.",link:"https://framer.com?via=julesvcode",features:"https://www.framer.com/features/design-layout?via=julesvcode",thumbnailImage:
						new Proxy({"src":"/_astro/framer-thumb.BTWcYR5K.png","width":1280,"height":720,"format":"png","fsPath":"/Users/new/Documents/GitHub/newsletter-supply/src/content/tools/images/framer-thumb.png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/new/Documents/GitHub/newsletter-supply/src/content/tools/images/framer-thumb.png";
							}
							
							return target[name];
						}
					})
					,thumbnailAlt:"Screenshot of the Framer website",categories:["website-builder"],topics:["launch","grow"],icon:
						new Proxy({"src":"/_astro/framer.CRTGaRzI.png","width":32,"height":32,"format":"png","fsPath":"/Users/new/Documents/GitHub/newsletter-supply/src/content/tools/favicons/framer.png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/new/Documents/GitHub/newsletter-supply/src/content/tools/favicons/framer.png";
							}
						...
						const _internal = {
							type: 'content',
							filePath: "/Users/new/Documents/GitHub/newsletter-supply/src/content/tools/framer.md",
							rawData: undefined,
						};
